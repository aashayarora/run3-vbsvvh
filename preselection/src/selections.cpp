...
RNode OneLepResolvedAnalysis(RNode df_) {
    ...
    df = df.Define("_jet_w_dR", VdR, {"Jet_eta", "Jet_phi", "boosted_w_candidate_eta", "boosted_w_candidate_phi"})
            ...
            .Define("hbb_candidate_pairs1_pt", "Take(Jet_pt, _hbb_candidate_pairs[0])")
            .Define("hbb_candidate_pairs2_pt", "Take(Jet_pt, _hbb_candidate_pairs[1])")
            .Define("hbb_candidate_pairs1_eta", "Take(Jet_eta, _hbb_candidate_pairs[0])")
            .Define("hbb_candidate_pairs2_eta", "Take(Jet_eta, _hbb_candidate_pairs[1])")
            .Define("hbb_candidate_pairs1_phi", "Take(Jet_phi, _hbb_candidate_pairs[0])")
            .Define("hbb_candidate_pairs2_phi", "Take(Jet_phi, _hbb_candidate_pairs[1])")
            .Define("hbb_candidate_pairs1_mass", "Take(Jet_mass, _hbb_candidate_pairs[0])")
            .Define("hbb_candidate_pairs2_mass", "Take(Jet_mass, _hbb_candidate_pairs[1])")
            .Define("hbb_candidate_pairs1_btag", "Take(Jet_btagUParTAK4B, _hbb_candidate_pairs[0])")
            .Define("hbb_candidate_pairs2_btag", "Take(Jet_btagUParTAK4B, _hbb_candidate_pairs[1])")
    ...
    df = df.Define("_jet_h_dR", VdR, {"Jet_eta", "Jet_phi", "boosted_h_candidate_eta", "boosted_h_candidate_phi"})
            ...
            .Define("v_candidate_pairs1_pt", "Take(Jet_pt, _v_candidate_pairs[0])")
            .Define("v_candidate_pairs2_pt", "Take(Jet_pt, _v_candidate_pairs[1])")
            .Define("v_candidate_pairs1_eta", "Take(Jet_eta, _v_candidate_pairs[0])")
            .Define("v_candidate_pairs2_eta", "Take(Jet_eta, _v_candidate_pairs[1])")
            .Define("v_candidate_pairs1_phi", "Take(Jet_phi, _v_candidate_pairs[0])")
            .Define("v_candidate_pairs2_phi", "Take(Jet_phi, _v_candidate_pairs[1])")
            .Define("v_candidate_pairs1_mass", "Take(Jet_mass, _v_candidate_pairs[0])")
            .Define("v_candidate_pairs2_mass", "Take(Jet_mass, _v_candidate_pairs[1])")
